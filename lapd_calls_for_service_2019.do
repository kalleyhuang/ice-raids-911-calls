...
clear
use lapd_calls_for_service_2019.dta
...
gen intervention = 1 if (date1 > date("06/17/2019", "MDY"))
...
drop if lowhl > 2200
#delimit;
line lowhl date2, xline(21717) || line midhl date2, xline(21717) || line highhl date2, xline(21717)
xtitle(Date)
ytitle(Total 911 Calls)
title("Hispanic and Non Hispanic 911 Calls")
subtitle("Los Angeles Police Department, 2019")
note("Assuming geographic uniformity.")
legend(label(1 "Low Hispanic(<39.3%)") label(2 "Mid Hispanic") label (3 "High Hispanic (>70%)"))
;
graph export 911_Calls_2019.png, width(2000) replace
