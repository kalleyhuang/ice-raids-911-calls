...
collapse (sum) wtotalpopulation wwhitealone wblackalone windigenousalone wasianalone wpacificislanderalone wsomeotherracealone wtwoormoreraces wnothispanicorlatinx wnothlwhitealone wnothlblackalone wnothlindigenousalone wnothlasianalone wnothlpacificislanderalone wnothlsomeotherracealone wnothltwoormoreraces whispanicorlatinx whlwhitealone whlblackalone whlindigenousalone whlasianalone whlpacificislanderalone whlsomeotherraceaone whltwoormoreraces wnativeborn wforeignborn wnaturalizedcitizen wnotacitizen, by(area)
// changed rd to area
gen hl = 0
recode hl 0 = 1 if (whispanicorlatinx/wtotalpopulation) <= 0.393
recode hl 0 = 2 if ((whispanicorlatinx/wtotalpopulation) > 0.393) & ((whispanicorlatinx/wtotalpopulation) < 0.7)
recode hl 0 = 3 if (whispanicorlatinx/wtotalpopulation) >= 0.7
tab hl
